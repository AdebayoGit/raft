...
namespace margelo::nitro::raft::bridge::swift {
  ...
  /**
   * Specialized version of `std::function<void(const QueryResult&)>`.
   */
  using Func_void_QueryResult = std::function<void(const QueryResult& /* result */)>;
  /**
   * Wrapper class for a `std::function<void(const QueryResult& / * result * /)>`, this can be used from Swift.
   */
  class Func_void_QueryResult_Wrapper final {
  public:
    explicit Func_void_QueryResult_Wrapper(std::function<void(const QueryResult& /* result */)>&& func): _function(std::make_unique<std::function<void(const QueryResult& /* result */)>>(std::move(func))) {}
    inline void call(QueryResult result) const noexcept {
      _function->operator()(result);
    }
  private:
    std::unique_ptr<std::function<void(const QueryResult& /* result */)>> _function;
  } SWIFT_NONCOPYABLE;
  Func_void_QueryResult create_Func_void_QueryResult(void* NON_NULL swiftClosureWrapper) noexcept;
  inline Func_void_QueryResult_Wrapper wrap_Func_void_QueryResult(Func_void_QueryResult value) noexcept {
    return Func_void_QueryResult_Wrapper(std::move(value));
  }
  
  // pragma MARK: std::shared_ptr<HybridRaftSpec>
  /**
   * Specialized version of `std::shared_ptr<HybridRaftSpec>`.
   */
  using std__shared_ptr_HybridRaftSpec_ = std::shared_ptr<HybridRaftSpec>;
  ...
  // pragma MARK: std::weak_ptr<HybridRaftSpec>
  using std__weak_ptr_HybridRaftSpec_ = std::weak_ptr<HybridRaftSpec>;
  inline std__weak_ptr_HybridRaftSpec_ weakify_std__shared_ptr_HybridRaftSpec_(const std::shared_ptr<HybridRaftSpec>& strong) noexcept { return strong; }
