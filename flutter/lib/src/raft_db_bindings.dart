...
class RaftDbBindings {
  ...
  /// which yields null).
  ffi.Pointer<ffi.Uint8> rft_buf_data(ffi.Pointer<RftBuf> buf) {
    return _rft_buf_data(buf);
  }

  late final _rft_buf_dataPtr =
      _lookup<
        ffi.NativeFunction<ffi.Pointer<ffi.Uint8> Function(ffi.Pointer<RftBuf>)>
      >('rft_buf_data');
  late final _rft_buf_data = _rft_buf_dataPtr
      .asFunction<ffi.Pointer<ffi.Uint8> Function(ffi.Pointer<RftBuf>)>();
  ...
  ///
  /// `buf` must be a live handle from [`rft_collection_scan`] or null.
  int rft_buf_len(ffi.Pointer<RftBuf> buf) {
    return _rft_buf_len(buf);
  }

  late final _rft_buf_lenPtr =
      _lookup<ffi.NativeFunction<ffi.UintPtr Function(ffi.Pointer<RftBuf>)>>(
        'rft_buf_len',
      );
  late final _rft_buf_len = _rft_buf_lenPtr
      .asFunction<int Function(ffi.Pointer<RftBuf>)>();
  ...
  /// null.
  void rft_buf_free(ffi.Pointer<RftBuf> buf) {
    return _rft_buf_free(buf);
  }

  late final _rft_buf_freePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<RftBuf>)>>(
        'rft_buf_free',
      );
  late final _rft_buf_free = _rft_buf_freePtr
      .asFunction<void Function(ffi.Pointer<RftBuf>)>();
  ...
  /// `batch_len == 0`).
  int rft_collection_put_many(
    ffi.Pointer<RaftDb> db,
    ffi.Pointer<ffi.Char> collection,
    ffi.Pointer<ffi.Uint8> batch,
    int batch_len,
  ) {
    return _rft_collection_put_many(db, collection, batch, batch_len);
  }

  late final _rft_collection_put_manyPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Uint32 Function(
            ffi.Pointer<RaftDb>,
        ...
        >
      >('rft_collection_put_many');
  late final _rft_collection_put_many = _rft_collection_put_manyPtr
      .asFunction<
        int Function(
          ffi.Pointer<RaftDb>,
          ffi.Pointer<ffi.Char>,
  ...
  /// `count == 0`).
  int rft_collection_delete_many(
    ffi.Pointer<RaftDb> db,
    ffi.Pointer<ffi.Char> collection,
    ffi.Pointer<ffi.Uint64> ids,
    int count,
  ) {
    return _rft_collection_delete_many(db, collection, ids, count);
  }

  late final _rft_collection_delete_manyPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Uint32 Function(
            ffi.Pointer<RaftDb>,
  ...
  late final _rft_collection_delete_many = _rft_collection_delete_manyPtr
      .asFunction<
        int Function(
          ffi.Pointer<RaftDb>,
          ffi.Pointer<ffi.Char>,
  ...
  int rft_collection_scan(
    ffi.Pointer<RaftDb> db,
    ffi.Pointer<ffi.Char> collection,
    ffi.Pointer<ffi.Pointer<RftBuf>> out_buf,
  ) {
    return _rft_collection_scan(db, collection, out_buf);
  }

  late final _rft_collection_scanPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Uint32 Function(
            ffi.Pointer<RaftDb>,
            ffi.Pointer<ffi.Char>,
            ffi.Pointer<ffi.Pointer<RftBuf>>,
          )
        >
      >('rft_collection_scan');
  late final _rft_collection_scan = _rft_collection_scanPtr
      .asFunction<
        int Function(
          ffi.Pointer<RaftDb>,
          ffi.Pointer<ffi.Char>,
  ...
  int rft_collection_get_buf(
    ...
    return _rft_collection_get_buf(db, collection, doc_id, out_buf, out_len);
  }

  late final _rft_collection_get_bufPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Uint32 Function(
            ffi.Pointer<RaftDb>,
        ...
        >
      >('rft_collection_get_buf');
  late final _rft_collection_get_buf = _rft_collection_get_bufPtr
      .asFunction<
        int Function(
          ffi.Pointer<RaftDb>,
          ffi.Pointer<ffi.Char>,
  ...
  /// **before** `db` is closed.
  int rft_collection_open(
    ffi.Pointer<RaftDb> db,
    ffi.Pointer<ffi.Char> collection,
    ffi.Pointer<ffi.Pointer<RaftCollection>> out_coll,
  ) {
    return _rft_collection_open(db, collection, out_coll);
  }

  late final _rft_collection_openPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Uint32 Function(
            ffi.Pointer<RaftDb>,
            ffi.Pointer<ffi.Char>,
            ffi.Pointer<ffi.Pointer<RaftCollection>>,
          )
        >
      >('rft_collection_open');
  late final _rft_collection_open = _rft_collection_openPtr
      .asFunction<
        int Function(
          ffi.Pointer<RaftDb>,
          ffi.Pointer<ffi.Char>,
  ...
  void rft_collection_close(ffi.Pointer<RaftCollection> coll) {
    return _rft_collection_close(coll);
  }

  late final _rft_collection_closePtr =
      _lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<RaftCollection>)>
      >('rft_collection_close');
  late final _rft_collection_close = _rft_collection_closePtr
      .asFunction<void Function(ffi.Pointer<RaftCollection>)>();
  ...
  /// [`rft_collection_close`].
  ffi.Pointer<ffi.Uint64> rft_coll_generation(
    ffi.Pointer<RaftCollection> coll,
  ) {
    return _rft_coll_generation(coll);
  }

  late final _rft_coll_generationPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Uint64> Function(ffi.Pointer<RaftCollection>)
        >
      >('rft_coll_generation');
  late final _rft_coll_generation = _rft_coll_generationPtr
      .asFunction<
        ffi.Pointer<ffi.Uint64> Function(ffi.Pointer<RaftCollection>)
      >();
  ...
  int rft_coll_get_buf(
    ffi.Pointer<RaftCollection> coll,
    int doc_id,
    ffi.Pointer<ffi.Uint8> out_buf,
    ffi.Pointer<ffi.UintPtr> out_len,
  ) {
    return _rft_coll_get_buf(coll, doc_id, out_buf, out_len);
  }

  late final _rft_coll_get_bufPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Uint32 Function(
            ffi.Pointer<RaftCollection>,
            ffi.Uint64,
            ffi.Pointer<ffi.Uint8>,
            ffi.Pointer<ffi.UintPtr>,
          )
        >
      >('rft_coll_get_buf');
  late final _rft_coll_get_buf = _rft_coll_get_bufPtr
      .asFunction<
        int Function(
          ffi.Pointer<RaftCollection>,
          int,
  ...
  int rft_coll_get_many(
    ffi.Pointer<RaftCollection> coll,
    ffi.Pointer<ffi.Uint64> ids,
    int count,
    ffi.Pointer<ffi.Pointer<RftBuf>> out_buf,
  ) {
    return _rft_coll_get_many(coll, ids, count, out_buf);
  }

  late final _rft_coll_get_manyPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Uint32 Function(
            ffi.Pointer<RaftCollection>,
        ...
        >
      >('rft_coll_get_many');
  late final _rft_coll_get_many = _rft_coll_get_manyPtr
      .asFunction<
        int Function(
          ffi.Pointer<RaftCollection>,
          ffi.Pointer<ffi.Uint64>,
...
final class RaftCollection extends ffi.Opaque {}
...
final class RftBuf extends ffi.Opaque {}
